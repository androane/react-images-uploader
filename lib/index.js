...
var ImagesUploader = (_class = function (_Component) {
	...
	(0, _createClass3.default)(ImagesUploader, [{
							...
							case 0:
								if (url) {
									try {
										...
										_axios2.default.post(url, imageFormData).then(function (response) {
		...
		value: function handleImageChange(e) {
			...
			var imagePreviewUrls = (_state$filesListState = this.state.filesListState).concat.apply(_state$filesListState, (0, _toConsumableArray3.default)(filesList));
